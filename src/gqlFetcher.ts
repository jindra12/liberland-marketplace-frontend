...
export const gqlFetcher = <TData, TVariables extends object | undefined>(query: string, variables?: TVariables, options?: RequestInit['headers'], url?: string) => async (): Promise<TData> => {
