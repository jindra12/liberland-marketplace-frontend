...
export const AddToCartIncrementForm: React.FunctionComponent<AddToCartIncrementFormProps> = ({
    productId,
    variantId,
    serverURL,
    size = "large",
    ...
    const submitButtonProps = isAuthenticated
        ? {
    ...
    return (
        <Form component={false} className={formClassName} form={form} onFinish={handleFinish} initialValues={{ quantity: 1 }}>
