...
export const PublishForms: React.FunctionComponent<PublishFormsProps> = ({ url }) => {
    ...
    if (category === "company") {
        return (
            <div className="Publish">
                ...
                <CompanyForm mode="create" url={url} />
            </div>
        );
    }
    ...
    if (category === "product") {
        return (
            <div className="Publish">
                ...
                <ProductForm mode="create" url={url} />
            </div>
        );
    }
