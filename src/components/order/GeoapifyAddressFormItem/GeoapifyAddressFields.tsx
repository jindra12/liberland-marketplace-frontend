...
export const GeoapifyAddressFields: React.FunctionComponent<GeoapifyAddressFieldsProps> = (props) => {
    ...
    return (
        <>
            <Form.Item
                name={[...props.basePath, "addressLine1"]}
                label="Address line 1"
                rules={[...requiredRule, buildMaxLengthRule(TEXT_INPUT_MAX_LENGTH)]}
            >
                <Input placeholder="Street and house number" />
            </Form.Item>

            <Form.Item
                name={[...props.basePath, "addressLine2"]}
            ...
            <Row gutter={12}>
                ...
                <Col xs={24} md={12}>
                    <Form.Item name={[...props.basePath, "state"]} label="State / Region" rules={[buildMaxLengthRule(TEXT_INPUT_MAX_LENGTH)]}>
                        <Input />
                    </Form.Item>
                </Col>
            </Row>
            ...
            <Row gutter={12}>
                <Col xs={24} md={12}>
                    <Form.Item
                        name={[...props.basePath, "postalCode"]}
                        label="Postal code"
                        rules={[...requiredRule, buildMaxLengthRule(TEXT_INPUT_MAX_LENGTH)]}
                    >
                        <Input />
