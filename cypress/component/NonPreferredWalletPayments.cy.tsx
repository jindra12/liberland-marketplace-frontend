...
const payWithNonPreferredWallet = (chainLabel: string) => {
...
describe("non-preferred wallet payments", () => {
    it("allows Solana, Thirdweb, and Tron payments with a non-preferred wallet", () => {
        ...
        payWithNonPreferredWallet("Solana (SOL)");
        payWithNonPreferredWallet("Ethereum (ETH)");
        payWithNonPreferredWallet("Tron (TRX)");
    });
});
